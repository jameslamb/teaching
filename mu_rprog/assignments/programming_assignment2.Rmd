...
For the remainder of this assignment, I'll refer to **the package list**. Please see [the list on GitHub](https://github.com/jameslamb/teaching/blob/main/mu_rprog/assignments/final_project_packages.md).
