...
This component of the project is **due prior to our Week 4 session (Feb 10)**.
...
Code reviews will be done in-class **during our Week 5 session (Feb 17)**. You do not need to present slides or turn in anything on D2L.
...
This component of the project is **due prior to our Week 5 session (Feb 17)**. Please upload your report to the "Final Project (script + report)" dropbox on D2L.
