...
1. **Read in data from the internet**
    ...
    - Please see this [list of example data sources](https://github.com/jameslamb/teaching/blob/main/mu_rprog/assignments/some_data_sources.md) for some ideas to get you started
...
When this course is taught in-person, code reviews will be done in-class **during our Week 5 session**. You do not need to present slides or turn in anything on D2L. Please set up a Google doc called "FIRSTNAME LASTNAME <> MU RPROG Code Review" and give the rest of the class edit rights. While you present, everyone in the class will have this doc up on their machines and use it to give you comments and questions. The benefit of this practice, in professional settings, is that days after your code review you'll have a written record of your audience's feedback.

<h3>Submission (asynchronous class)</h3>

When this course is taught asynchronously, students are expected to record their final project code reviews and upload them to the "Final Project Code Reviews" dropbox under the "Assessments" section in D2L.

Once all final project code reviews have been submitted, they'll all be made available so you can see each others' presentations. You are then responsible for watching all other final projects and providing written feedback. These notes can just be bullet points with comments and questions. Upload a single document to the "Peer Review" dropbox under the "Assessmets" section in D2L.

Peer reviews will not affect your grade. However, if you fail to submit peer review for all of your classmates by the date indicated in the syllabus, 25 points will be subtracted from your code review grade.
