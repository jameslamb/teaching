...
To complete this assignment, fill out the body of the function defined below. Do not remove or change any of the code or comments. The function assums that the input is the built-in `attitude` dataset.
