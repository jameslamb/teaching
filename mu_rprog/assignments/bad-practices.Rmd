...
This article describes some practices that are common in R programming but should be avoided because they make programs slow, hard to maintain, or unsafe.
