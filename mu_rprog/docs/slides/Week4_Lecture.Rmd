...
<ol class = "toc" type="none">
    <li> Columnwise Combination<span style="float:right"> 13-14 </span></li>
    <li> Rowwise Combination<span style="float:right">    15-16 </span></li>
</ol>
...
<ol class = "toc" type="none">
    <li> Getting Your Project Off the Ground<span style="float:right"> 18 </span></li>
    <li> Step 1: Build a Comment Skeleton<span style="float:right">    19 </span></li>
    <li> Step 2: Define Functions <span style="float:right">           20 </span></li>
    <li> Step 3: Fill in Your Code! <span style="float:right">         21 </span></li>
</ol>

<b class="toc_header"> IV. Final Project Discussion </b>
<ol class = "toc" type="none">
    <li> Code Review Tips <span style="float:right">       23 </span></li>
    <li> Scripting: Style Notes <span style="float:right"> 24 </span></li>
    <li> Lingering Questions <span style="float:right">    25 </span></li>
</ol>
...
<br>
Please follow along with the code in the [Week 4 Programming Supplement](https://jameslamb.github.io/teaching/mu_rprog/docs/code/Week4_Supplement.html).
...
<br>
For more, see the [Week 4 Programming Supplement](https://jameslamb.github.io/teaching/mu_rprog/docs/code/Week4_Supplement.html).
...
A sample script following these prescriptions is provided in the [Week 4 Programming Supplement](https://jameslamb.github.io/teaching/mu_rprog/docs/code/Week4_Supplement.html).
