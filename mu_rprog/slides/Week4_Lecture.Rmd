...
<ol class = "toc" type="none">
    ...
    <li> OLS With Multiple RHS Variables <span style="float:right"> 13 </span></li>
...
<ol class = "toc" type="none">
    <li> Columnwise Combination <span style="float:right"> 17-18 </span></li>
    <li> Rowwise Combination <span style="float:right"> 19-20 </span></li>
</ol>
...
<ol class = "toc" type="none">
    <li> Common Preprocessing Steps <span style="float:right"> 22 </span></li>
    <li> Intro to Regular Expressions <span style="float:right"> 23-24 </span></li>
    <li> Tokenization <span style="float:right"> 25 </span></li>
    <li> Counting Words in Text <span style="float:right"> 26 </span></li>
</ol>
...
<ol class = "toc" type="none">
    <li> Getting Your Project Off the Ground <span style="float:right"> 28 </span></li>
    <li> Step 1: Build a Comment Skeleton <span style="float:right"> 29 </span></li>
    <li> Step 2: Define Functions <span style="float:right"> 30 </span></li>
    <li> Step 3: Fill in Your Code! <span style="float:right"> 31 </span></li>
</ol>
...
<ol class = "toc" type="none">
    <li> Code Review Tips <span style="float:right"> 33 </span></li>
    <li> Scripting: Style Notes <span style="float:right"> 34 </span></li>
    <li> Lingering Questions <span style="float:right"> 35 </span></li>
</ol>
