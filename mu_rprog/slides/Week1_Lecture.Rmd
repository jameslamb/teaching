...
<ol class="toc" type="none">
    ...
    <li> Lists <span style="float:right"> 28-29 </span></li>
    <li> Factors      <span style="float:right"> 30-31 </span></li>
    <li> Data Frames      <span style="float:right"> 32-34 </span></li>
</ol>
...
<ol class="toc" type="none">
    <li> Logical Operators <span style="float:right"> 36-38 </span></li>
</ol>

<b class="toc_header"> Subsetting </b>
<ol class="toc" type="none">
    <li> Subsetting Vectors <span style="float:right"> 40 </span></li>
    <li> Subsetting Lists <span style="float:right"> 41 </span></li>
    <li> Subsetting Data Frames <span style="float:right"> 42 </span></li>
    <li> Using Logical Vectors <span style="float:right"> 43 </span></li>
</ol>

<b class="toc_header"> Controlling Program Flow </b>

<ol class = "toc" type="none">
    <li> If-Else <span style="float:right"> 45-46 </span></li>
    <li> For Loops <span style="float:right"> 47 </span></li>
    <li> While Loops <span style="float:right"> 48-49 </span></li>
</ol>
...
<ol class = "toc" type="none">
    <li> Learning More on Your Own<span style="float:right"> 51 </span></li>
</ol>
