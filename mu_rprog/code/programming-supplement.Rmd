...
# Go get some data
json_url <- "https://raw.githubusercontent.com/jameslamb/teaching/main/mu_rprog/sample-data/tweets.json"
...
# Check out the URLs in the tweet
str(result[["entities"]][["urls"]])
```
...
3. Run `devtools::install_local()` to install the package!

```{r, eval = FALSE, echo = TRUE}
devtools::install_local(package_path, force = TRUE)
```
