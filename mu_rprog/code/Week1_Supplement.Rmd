...
This document contains code is too long to display in the week's slides. Unlike code in the slides, all examples below are executed so you can see the values.
