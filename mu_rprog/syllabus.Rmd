...
**YOU WILL PRESENT YOUR FINAL PROJECT ON A VIDEO CALL SATURDAY, FEBRUARY 17, 9:00a-12:00P CT**.
...
5. **(due January 20, 2024)** Take the `pre-course survey` on D2L
...
8. **(due January 27, 2024)** Complete `Quiz 1`
...
11. **(due February 3, 2024)** Complete `Quiz 2`
12. **(due February 3, 2024)** Submit `Programming Assignment 1`
...
16. **(due February 10, 2024)** Submit `Programming Assignment 2`
17. **(due February 10, 2024)** Submit `Final Project Proposal`
...
20. **(due February 17, 2024)** Submit `Final Project Script(s)`
21. **(due February 17, 2024)** Attend `Final Project Code Review` (video call)
  * present your final project code to your classmates
  * provide peer review feedback to your classmates
22. **(due February 20, 2024)** *(optional)* complete `Extra Credit Assignment`
