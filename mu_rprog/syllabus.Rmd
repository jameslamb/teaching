...
3. **(due January 20, 2024)** Take the `pre-course survey` on D2L
...
6. **(due January 27, 2024)** Complete `Quiz 1`
...
14. **(due February 3, 2024)** Complete `Quiz 2`
15. **(due February 3, 2024)** Submit `Programming Assignment 1`
...
19. **(due February 10, 2024)** Submit `Programming Assignment 2`
20. **(due February 10, 2024)** Submit `Final Project Proposal`
...
23. **(due February 17, 2024)** Submit `Final Project Script(s)`
24. **(due February 17, 2024)** Attend `Final Project Code Review` (Zoom call)
  * present your final project code to your classmates
  * provide peer review feedback to your classmates
25. **(due February 20, 2024)** *(optional)* complete `Extra Credit Assignment`
