---
title: "ECON 6114: R Programming (Spring 2024)"
output:
  html_document:
...
3. Watch the course intro video ([link](https://drive.google.com/file/d/1BHRiFxOTSNRXyD1rAF7CPa7MC3xD3sRf/view?usp=drive_link))
4. **(due January 20, 2024)** Take the `pre-course survey` on D2L
...
6. Review Week 1 lecture materials
...
10. **(due February 3, 2024)** Complete `Quiz 2`
11. **(due February 3, 2024)** Submit `Programming Assignment 1`
12. Watch solution videos
...
13. Review Week 3 lecture materials
...
12. Review Final Project materials
...
13. **(due February 10, 2024)** Submit `Programming Assignment 2`
14. **(due February 10, 2024)** Submit `Final Project Proposal`
15. Watch solution videos
    * Programming Assignment 2 ([link](https://drive.google.com/file/d/1BjkwPfre3iRSeY6HjzMWPQy8VKh7qFl1/view?usp=drive_link))
16. Review Week 4 lecture materials
...
17. **(due February 17, 2024)** Submit `Final Project Script(s)`
18. **(due February 17, 2024)** Attend `Final Project Code Review` (Zoom call)
  * present your final project code to your classmates
  * provide peer review feedback to your classmates
19. **(due February 20, 2024)** *(optional)* complete `Extra Credit Assignment`
...
|Quiz                       |Opens                             |Due                         |
|:-------------------------:|:--------------------------------:|:--------------------------:|
|Pre-class survey           | Immediately                      | 11:00p on January 20, 2024 |
|Quiz 1                     | Immediately                      | 11:00p on January 27, 2024 |
|Quiz 2                     | Immediately                      | 11:00p on February 3, 2024 |
...
|Assignment                 |Due                          |
|:-------------------------:|:---------------------------:|
|Programming Assignment 1   | 11:00p on February 3, 2024  |
|Programming Assignment 2   | 11:00p on February 10, 2024 |
...
This extra credit must be submitted prior to midnight on February 21, 2024.
