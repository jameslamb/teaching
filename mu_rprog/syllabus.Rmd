---
title: "ECON 6114: R Programming (Spring 2025)"
output:
  html_document:
...
**YOU WILL PRESENT YOUR FINAL PROJECT ON A VIDEO CALL SATURDAY, FEBRUARY 15, 9:00a-12:00P CT**.
...
5. **(due January 18, 2025)** Take the `pre-course survey` on D2L
6. Set up your development environment
    * install R on your personal computer (https://cloud.r-project.org/)
    * install RStudio on your personal computer (https://www.rstudio.com/products/rstudio/download/)
...
8. **(due January 25, 2025)** Complete `Quiz 1`
...
11. **(due February 1, 2025)** Complete `Quiz 2`
12. **(due February 1, 2025)** Submit `Programming Assignment 1`
...
16. **(due February 8, 2025)** Submit `Programming Assignment 2`
17. **(due February 8, 2025)** Submit `Final Project Proposal`
...
20. **(due February 15, 2025)** Submit `Final Project Script(s)`
21. **(due February 15, 2025)** Attend `Final Project Code Review` (video call)
  * present your final project code to your classmates
  * provide peer review feedback to your classmates
22. **(due February 20, 2025)** *(optional)* complete `Extra Credit Assignment`
...
|Quiz                       |Opens                             |Due                         |
|:-------------------------:|:--------------------------------:|:--------------------------:|
|Pre-class survey           | Immediately                      | 11:00p on January 18, 2025 |
|Quiz 1                     | Immediately                      | 11:00p on January 25, 2025 |
|Quiz 2                     | Immediately                      | 11:00p on February 1, 2025 |
...
|Quiz                       |Opens                             |Due                         |
|:-------------------------:|:--------------------------------:|:--------------------------:|
|Programming Assignment 1   | Immediately                      | 11:00p on February 1, 2025 |
|Programming Assignment 2   | Immediately                      | 11:00p on February 8, 2025 |
...
|:-------------------------------------:|:------------------:|:----------------------------:|
|Final Project proposal                 | Immediately        |11:00p on February 8, 2025    |
|Final Project (script + report)        | Immediately        |11:00p on February 15, 2025   |
|Final Project code review presentation | Immediately        |live, 9:00a February 15, 2025 |
...
This extra credit must be submitted prior to midnight on February 20, 2025.
...
See https://www.marquette.edu/central/registrar/2025-spring-academic-calendar.php for dates like the deadlines
