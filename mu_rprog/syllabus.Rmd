...
**Instructor:** James Lamb - jaylamb20@gmail.com | [GitHub](https://github.com/jameslamb)
...
Weeks 1-4 of the course are *asynchronous*.
I've provided pre-recorded lecture videos which you are encouraged to watch at a time that works for you.

Week 5 is a **virtual, synchronous** session, where students will present their final projects on a video call.

### Week 1 (ends July 15, 2023)
...
* Environment setup
* Introduction to R
* Variables, namespaces, objects, and types
* Basic math operations in R
* Data structures
* Subsetting
* Controlling program flow (if, for, while)

### Week 2 (ends July 22, 2023)
...
5. *Final Project peer review*: Written feedback for three of your classmates' presentations.
...
- **Cheating**
  ...
  - Sharing answers for a take-home exam or assignment unless specifically authorized by the instructor.
