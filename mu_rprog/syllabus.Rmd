...
21. **(due February 14, 2026)** Attend `Final Project Code Review` (video call)
  * present your final project code to your classmates
  * provide peer review feedback to your classmates
22. **(due February 17, 2026)** *(optional)* complete `Extra Credit Assignment`
...
|Quiz                       |Opens                             |Due                         |
|:-------------------------:|:--------------------------------:|:--------------------------:|
|Pre-course survey          | Immediately                      | 11:00p on January 17, 2026 |
|Quiz 1                     | Immediately                      | 11:00p on January 24, 2026 |
|Quiz 2                     | Immediately                      | 11:00p on January 31, 2026 |
...
|Quiz                       |Opens                             |Due                         |
|:-------------------------:|:--------------------------------:|:--------------------------:|
|Programming Assignment 1   | Immediately                      | 11:00p on January 24, 2026 |
|Programming Assignment 2   | Immediately                      | 11:00p on January 31, 2026 |
...
|:-------------------------------------:|:------------------:|:----------------------------:|
|Final Project proposal                 | Immediately        |11:00p on February 7, 2026    |
|Final Project (script + report)        | Immediately        |11:00p on February 14, 2026   |
|Final Project code review presentation | Immediately        |live, 9:00a February 14, 2026 |
...
This extra credit must be submitted prior to midnight on February 17, 2026.
