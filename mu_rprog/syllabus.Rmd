...
The course begins on 1/19/2019. Before class on that date, please do the following:
...
\underline{Week 1: January 26, 2019}
...
\underline{Week 2: February 2, 2019}
...
\underline{Week 3: February 9, 2019}
...
\underline{Week 4: February 16, 2019}
...
\underline{Week 5: February 23, 2019}
...
|Quiz                       |Opens                       |Due                           |
|:-------------------------:|:--------------------------:|:----------------------------:|
|Pre-class survey           | Immediately                | Prior to class on January 26 |
|Quiz 1                     | After class on January 26  | Prior to class on February 2 |
|Quiz 2                     | After class on February 2  | Prior to class on February 9 |
...
|:-------------------------:|:--------------------------:|:-----------------------------:|
|Programming Assignment 1   | Immediately                | Prior to class on February 9  |
|Programming Assignment 2   | Immediately                | Prior to class on February 16 | 
...
|Assignment                      |Description Available       |Due                            |
|:------------------------------:|:--------------------------:|:-----------------------------:|
|Final Project proposal          | After class on January 26  | Prior to class on February 16 |
|Final Project (script + report) | After class on February 2  | Prior to class on February 23 |
|Final Project code review       | After class on February 2  | In class on February 23       |
