...
We will be working with the [R programming language](https://www.r-project.org/). For script editing and exploratory analysis, we'll use [RStudio](https://www.rstudio.com/), a very popular integrated development environment (IDE) for R. For working with other text files, such as READMEs and JSON data downloaded from the web, you can use any text editor. I personally prefer [Sublime Text](http://www.sublimetext.com/3).
...
The course begins on 1/20/2018. Before class on that date, please do the following:
...
- Try to [install R v3.4.3](https://cloud.r-project.org/) or higher on your personal laptop
...
\underline{Week 1: January 20, 2018}
...
\underline{Week 2: January 27, 2018}
...
\underline{Week 3: February 3, 2018}
...
\underline{Week 4: February 10, 2018}
...
\underline{Week 5: February 17, 2018}
...
|Quiz                       |Opens                       |Due                           |
|:-------------------------:|:--------------------------:|:----------------------------:|
|Pre-class survey           | Immediately                | Prior to class on January 20 |
|Quiz 1                     | After class on January 20  | Prior to class on January 27 |
|Quiz 2                     | After class on January 27  | Prior to class on February 3 |
...
|:-------------------------:|:--------------------------:|:----------------------------:|
|Programming Assignment 1   | Immediately                | Prior to class on February 3 |
|Programming Assignment 2   | Immediately                | Prior to class on February 10| 
...
|Assignment                      |Description Available       |Due                            |
|:------------------------------:|:--------------------------:|:-----------------------------:|
|Final Project proposal          | After class on January 20  | Prior to class on February 10 |
|Final Project (script + report) | After class on January 27  | Prior to class on February 17 |
|Final Project code review       | After class on January 27  | In class on February 17       |
