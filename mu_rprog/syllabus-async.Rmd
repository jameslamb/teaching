...
Virtual office hours will be available every week, starting the week before the class.

- Every Thursday from 4:00p-6:00p CST
- Every Sunday from 9:00a-11:00a CST

If these times don't work for you or you'd like to talk 1-on-1, please email me and we can find another time that works.

These will be video calls using Zoom. Prior to the beginning of the class, you'll receive calendar invitations for all office hours, with information on how to join.
...
Instructions for setting up these components can be found in the section below. Download and installation instructions are given in this syllabus, but please come to office hours if you need additional help.
...
The course begins on 5/24/2021. Before that date, please do the following:
...
- Try to [install R v4.1.0](https://cloud.r-project.org/) or higher on your personal laptop
...
All lecture videos will be available immediately on the first day of class. Additional videos explaining the answers to quizzes and homework assignments will be posted after the deadlines for those items have passed.

All videos can be accessed under the "Content" section on D2L.

\underline{Week 1: June 5, 2021}
...
Quizzes will be delivered online via D2L (see the "Quizzes" section of the course site). Quizzes have no time limit. You will be allowed two attempts for each quiz and your grade on each quiz will be the better of your two scores.

|Quiz                       |Opens                             |Due                      |
|:-------------------------:|:--------------------------------:|:-----------------------:|
|Pre-class survey           | Immediately                      | 12:00p on June 5, 2021  |
|Quiz 1                     | Immediately                      | 12:00p on June 12, 2021 |
|Quiz 2                     | Immediately                      | 12:00p on June 19, 2021 |
...
|Assignment                 |Due                      |
|:-------------------------:|:-----------------------:|
|Programming Assignment 1   | 12:00p on June 19, 2021 |
|Programming Assignment 2   | 12:00p on June 26, 2021 |
...
\begin{enumerate}
    ...
    \item \emph{Final project code review}: A 5-10 minute overview of your project. You will record
        a video of yourself presenting your final project and submit it on D2L.
...
|Assignment                      |Due                       |
|:------------------------------:|:------------------------:|
|Final Project proposal          | 12:00p on June 26, 2021  |
|Final Project (script + report) | 12:00p on July 2, 2021   |
|Final Project code review video | 12:00p on July 2, 2021   |
|Final Project peer reviews      | 12:00p on July 2, 2021   |
